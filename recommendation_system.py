...
df = pd.read_csv('C:/AccommodationsWeb/storage/app/recommendation_dataset.csv')
...
#checkin the arguments retrieved from the controller
if len(sys.argv) <2:
    print("Error: Please provide user origin and destination as command-line arguments.")
    print(len(sys.argv))
    print(sys.argv[0])
    sys.exit(1)
