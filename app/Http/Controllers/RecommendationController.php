...
//here
        ...
        $pythonExecutable = 'C:\AccommodationsWeb\myenv\Scripts\python.exe';
        $process = new Process([$pythonExecutable, 'C:\AccommodationsWeb\recommendation_system.py', $userOrigin, $userDestination]);
        // $process = new Process([$pythonExecutable, 'C:\AccommodationsWeb\recommendation_system.py', 'Alexandria', 'Cairo']);
        $process->run();
        ...
        $jsonData = file_get_contents('C:\AccommodationsWeb\public\recommendation_output.json');
